    ...
    <form wire:submit="save">
        ...
        'border-2 border-red-500' => $errors->has('form.description'),
         ...
         'border-2 border-red-500' => $errors->has('form.max_participants'),
                    ...
                    {{--                                    <button type="button" class="text-red-500" wire:click="clearImage">X</button>--}}
                    ...
                    {{--                    </div>--}}
                    <div class="sm:grid sm:grid-cols-3 sm:items-start sm:gap-4 sm:py-6">
                        <label for="cover-photo" class="block text-sm font-medium leading-6 text-gray-900 sm:pt-1.5">
                            Event Images
                        </label>
                        <div class="mt-2 sm:col-span-2 sm:mt-0">
                            <div
                            ...
                            @if($form->event->photo_path)
                                <div class="relative mt-4">
                                    ...
                                    <img src="{{ asset('storage/' . $form->event->photo_path) }}" alt="Event Photo"
                                         class="w-9/12 object-cover object-center">
                                </div>
                            @endif
                        </div>
                    </div>
